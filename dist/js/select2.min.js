    ...
    var t = (function () {
            ...
            return (
                        ...
                        (s = function (e, t) {
                            ...
                            (t = function (t, n, r, i) {
                                var o,
                                    ...
                                    w = [],
                                    A = typeof r;
                                if (((m = b((i = i || t))), "undefined" === A || "function" === A)) {
                                    for (n = !n.length && r.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1)
                                        if ("require" === (u = (h = s(n[f], m)).f)) w[f] = a.require(t);
                                        else if ("exports" === u) (w[f] = a.exports(t)), ($ = !0);
                                        else if ("module" === u) o = w[f] = a.module(t);
                                        else if (g(l, u) || g(c, u) || g(d, u)) w[f] = _(u);
                                        else {
                                            if (!h.p) throw new Error(t + " missing " + u);
                                            h.p.load(h.n, v(i, !0), y(u), {}), (w[f] = l[u]);
                                        }
                                    (p = r ? r.apply(l[t], w) : void 0), t && (o && o.exports !== e && o.exports !== l[t] ? (l[t] = o.exports) : (p === e && $) || (l[t] = p));
                                } else t && (l[t] = r);
                            }),
                            (n = r = o = function (n, r, i, l, c) {
                                if ("string" == typeof n) return a[n] ? a[n](r) : _(s(n, b(r)).f);
                                if (!n.splice) {
                ...
                t.define("select2/results", ["jquery", "./utils"], function (e, t) {
                    ...
                    return (
                        ...
                        (n.prototype.option = function (n) {
                            ...
                            for (var s in (((null != n.element && o.call(n.element, ":disabled")) || (null == n.element && n.disabled)) && (delete i["aria-selected"], (i["aria-disabled"] = "true")),
                        ...
                        (n.prototype.bind = function (n, r) {
                            ...
                            this.$results.attr("id", o),
                                ...
                                n.on("results:message", function (e) {
                                    e.args.tags = this.$element[0].hasAttribute('tags');
                                    e.args.suggest = this.$element[0].hasAttribute('suggest');
                                    i.displayMessage(e);
                                }),
                                e.fn.mousewheel &&
                                ...
                                this.$results.on("mouseup", ".select2-results__option[aria-selected]", function (n) {
                                    ...
                                    "true" !== r.attr("aria-selected") ? i.trigger("select", { originalEvent: n, data: o }) : i.options.get("multiple") ? i.trigger("unselect", { originalEvent: n, data: o }) : i.trigger("close", {});
                                }),
                    ...
                    return (
                        ...
                        (r.prototype.query = function (e, t) {
                            ...
                            "function" == typeof i.url && (i.url = i.url.call(this.$element, e)),
                                ...
                                this.ajaxOptions.delay ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), (this._queryTimeout = window.setTimeout(o, this.ajaxOptions.delay))) : o();
                        }),
                        r
                    );
                }),
                    ...
                    return (
                        (e.prototype.query = function (e, t, n) {
                            (t.term = t.term || ""),
                                ...
                                //t.term.length < this.minimumInputLength ? this.trigger("results:message", { message: "inputTooShort", args: { minimum: this.minimumInputLength, input: t.term, params: t } }) : e.call(this, t, n);   //Original
                                //Checks if the suggest attribute added in the renderMultiSelectAutoCompleteNew function in databasejoin.php is present. If yes, provide an initial suggestion, if not, execute the original code to validate the number of characters
                                this.$element[0].hasAttribute('suggest') ? e.call(this, t, n) : t.term.length < this.minimumInputLength ? this.trigger("results:message", { message: "inputTooShort", args: { minimum: this.minimumInputLength, input: t.term, params: t } }) : e.call(this, t, n);
                        }),
                        e
                    );
                }),
                    ...
                    return (
                        ...
                        (e.prototype._checkIfMaximumSelected = function (e, t) {
                            ...
                            this.current(function (e) {
                                ...
                                n.maximumSelectionLength > 0 && r >= n.maximumSelectionLength ? n.trigger("results:message", { message: "maximumSelected", args: { maximum: n.maximumSelectionLength } }) : t && t();
                            });
                        }),
                        e
                    );
                ...
                t.define("select2/i18n/en", [], function () {
                    return {
                        ...
                        noResults: function (e) {
                            msg = e.tags ? "Nenhum registro encontrado. Tecle Enter para Adicionar." : "Nenhum registro encontrado."
                            return msg;
                        },
                        searching: function () {
                            return "Searching…";
                ...
                t.define(
                    ...
                    function (e, t, n, r, i, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, $, b, w, A, x, D, E, S, C) {
                        function O() {
                            this.reset();
                        }
                        return (
                            (O.prototype.apply = function (u) {
                                ...
                                if (
                                    (null == u.resultsAdapter &&
                                        ...
                                        u.selectOnClose && (u.resultsAdapter = c.Decorate(u.resultsAdapter, E))),
                        ...
                        (i.prototype._registerEvents = function () {
                            ...
                            this.on("open", function () {
                                ...
                                this.on("keypress", function (i) {
                                    var o = i.which;
                                    if (t.isOpen())
                                        if (o === r.ESC || o === r.TAB || (o === r.UP && i.altKey)) t.close(i), i.preventDefault();
                                        else if (o === r.ENTER) {
                                            var s = e("[id^=searchall]")[0];
                                            if (s) {
                                                var a = new Element("option", { value: e(".select2-search__field").val(), selected: !0 });
                                                e(a).attr("data-select2-id", n.GetUniqueElementId(a)), s.append(a), Fabrik.fireEvent("fabrik.list.dofilter", [this]);
                                            } else t.trigger("results:select", {});
                                            i.preventDefault();
                                        } else
                                            o === r.SPACE && i.ctrlKey
                                                ? (t.trigger("results:toggle", {}), i.preventDefault())
                                                : o === r.UP
                                                ? (t.trigger("results:previous", {}), i.preventDefault())
                                                : o === r.DOWN && (t.trigger("results:next", {}), i.preventDefault());
                                    else (o === r.ENTER || o === r.SPACE || (o === r.DOWN && i.altKey)) && (t.open(), i.preventDefault());
                                });
                        }),
