            ...
            return (
                    ...
                    return (
                        (e.prototype.query = function (e, t, n) {
                            (t.term = t.term || ""),
                                ...
                                this.$element[0].attributes[0].name == 'suggest' ? e.call(this, t, n) : t.term.length < this.minimumInputLength ? this.trigger("results:message", { message: "inputTooShort", args: { minimum: this.minimumInputLength, input: t.term, params: t } }) : e.call(this, t, n);
                        }),
                        e
                    );
                }),
                ...
                t.define("select2/i18n/en", [], function () {
                    return {
                        ...
                        noResults: function () {
                            return "Nenhum registro encontrado. Tecle Enter para Adicionar.";
                        },
                        searching: function () {
                            return "Searching…";
                        },
