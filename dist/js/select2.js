        ...
        if (key === KEYS.ESC || key === KEYS.TAB ||
          ...
          evt.preventDefault();
            ...
            if(elSearchAll){
              ...
              //get unique id for the option and add as attribute
              $(elOption).attr('data-select2-id', Utils.GetUniqueElementId(elOption));
              //append
              elSearchAll.append(elOption);
              //call fabrik event to trigger the filtering
