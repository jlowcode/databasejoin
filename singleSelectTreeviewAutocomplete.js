var initDivStA = document.getElementsByClassName('treeview-autocomplete-single');
if (initDivStA.length) {
    ...
    define(['jquery', root_urlStA + '/plugins/fabrik_element/databasejoin/tree.jquery.js'], function ($) {
        singleSelectTreeviewAutocomplete();
        ...
        return {
            singleSelectTreeviewAutocomplete: singleSelectTreeviewAutocomplete
        }
    });
}
